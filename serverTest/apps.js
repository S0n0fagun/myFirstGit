...
console.log(venusaur.moves);
for(let move of venusaur.moves)
console.log("MOVE"+move.move.name)
console.log(move);
console.log("---------------------------");
for(let vgd of move.version_group_details)
};
let level = vgd = vgd.move_learn_method.name === "level up" ? vgd.level_learned_at
console.log(vgd.move_learn_method.name+" "+level+" : ")
